...
def create_episode_file(cameras, height=TARGET_HEIGHT, width=TARGET_WIDTH,is_compression=False): 
    """
        v1, No compression
    """
...
def recording(robot, cameras, episode_path, simulation_context, is_compression=False):
    """
        v1, No compression
    """
