...
class DP3(BasePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor],phase_latent=None) -> Dict[str, torch.Tensor]:
        """
        ...
        # run sampling
        if phase_latent is not None:
            global_cond = torch.cat([global_cond, phase_latent], dim=-1)
    ...
    def compute_loss(self, batch,phase_latent=None):
        # normalize input
